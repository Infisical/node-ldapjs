...
Object.defineProperties(LDAPError.prototype, {
  ...
  dn: {
    ...
    set: function setDN (dn) {
      this.lde_dn = dn
    },
    configurable: false
  },
  referrals: {
    get: function getReferrals () {
      return this.lde_referrals || []
    },
    configurable: false
  }
})
...
module.exports.getError = function (res) {
  ...
  const error = new E(res.errorMessage || errObj.message,
    res.matchedDN || null,
    module.exports.getError)
  if (res.referrals && res.referrals.length > 0) {
    error.lde_referrals = res.referrals
  }
  return error
}
